...
-(instancetype)initWithNavigationController:(UINavigationController *)vc
{
    ...
    if (self) {
        ...
        //系统自带动画
        id target = _nav.interactivePopGestureRecognizer.delegate;
        SEL action = NSSelectorFromString(@"handleNavigationTransition:");
        _panGesture = [[UIPanGestureRecognizer alloc] initWithTarget:target action:action];
...
//-(void)panGestureHandelWithSystemTransition
//{
//    id target = self.nav.interactivePopGestureRecognizer.delegate;
//    SEL action = NSSelectorFromString(@"handleNavigationTransition:");
//    
